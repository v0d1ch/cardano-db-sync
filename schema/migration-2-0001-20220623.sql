...
BEGIN
  ...
  IF next_version = 1 THEN
    ...
    EXECUTE 'CREATe TABLE "cost_model"("id" SERIAL8  PRIMARY KEY UNIQUE,"hash" hash32type NOT NULL,"costs" jsonb NOT NULL,"block_no" word63type NOT NULL)' ;
